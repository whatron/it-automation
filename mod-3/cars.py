...
def process_data(data):
  ...
  for item in data:
    ...
    if item_year in total_years:
      total_years[item_year] = total_years[item_year] + item['total_sales']
    else:
      total_years[item_year] = item['total_sales']

  max_year = max(total_years, key=total_years.get)
  summary = [
